export const config = {
  ...
  // 公众号APP_ID
  APP_ID: "wxec51ab546994c3ca",

  // 公众号APP_SECRET
  APP_SECRET: "65772f3d07c708ed2dd8e954e214c281",
   ...
   *    id: "oggJz6BFiPESX--Ef0cfkI8c9pB8",
   *    // 你想对他发送的模板消息的模板ID
   *    useTemplateId: "3iPJAEpeA-DCAGSHqirTo0QOw7UGGKdSqOdDvCqLmpk",
  ...
  USERS: [
    {
      ...
      id: "oggJz6BFiPESX--Ef0cfkI8c9pB8",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "6A0KzxupkKjpM4tFrqR6y83yGm7ifqN9Hl05nppmYM4",
      // 他点击详情后跳转的页面,你可以设置成微博的热榜，也可以设置成其他，网址一定要填对；不填对也没关系，随便你，会打不开而已。
   ...
   */
  FESTIVALS: [
    {"type": "节日", "name": "恋爱", "year": "2022", "date": "08-31"},
  ],
